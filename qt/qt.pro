...
CONFIG += qt thread link_prl depend_prl
macx:CONFIG += x86_64
...
unix {	
      ...
      # Translations
      TRANSLATIONS    = /Users/hubert/pigale-1.3.15/qt/pigale_fr.ts
      translation.target = $$TRANSLATIONS
      translation.depends = $$HEADERS $$SOURCES
      translation.commands  =  $$MQTDIR/bin/lupdate qt.pro
      translationUp.target = pigale_fr.qm 
      translationUp.depends = $$TRANSLATIONS
      translationUp.commands  = $$MQTDIR/bin/lrelease qt.pro
      ...
      macx {   
          RC_FILE = pigale.icns
          #install
          deploy.commands  = $$MQTDIR/bin/macdeployqt pigale.app
...
message(qtdir: $$MQTDIR)
message(include: $$QTINCLUDE)
